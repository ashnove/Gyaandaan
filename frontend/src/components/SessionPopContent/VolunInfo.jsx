        ...
        <Container>
          ...
          <Sidebar>
            <div style={{ float: "right", display: "flex", columnGap: "2px" }}>
              <Button color="green" appearance="primary" onClick={() => props.sendMessage(ACCEPTED)}>Accept</Button>
              <Button color="red" appearance="primary" onClick={() => props.sendMessage(REJECTED)}>Reject</Button>
            </div>
          </Sidebar>
        </Container>
        <Footer>
